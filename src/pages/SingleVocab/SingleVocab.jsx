    ...
    <div>
      ...
      {vocab && (
        <div className="carousel-container">
          ...
          <button className="carousel-button" onClick={handleShowAnswer}>{showAnswer ? 'Hide Answer' : 'Show Answer'}</button>
          <div>
            <button className="carousel-button carousel-button-green" onClick={handleRemembered}>I remembered</button>
            <button className="carousel-button carousel-button-red" onClick={handleDidntRemember}>I didn't remember</button>
          </div>
        </div>
      )}
    </div>
